import { Icon, IconType, type IconTypeName, Input, Label } from "@nube-auth/components";
...
export const AVAILABLE_ICONS: IconOption[] = [
	...
	{ id: "grid", iconName: "Grid", name: "Grid", category: "Interface", keywords: ["layout", "tiles", "blocks"] },
	{
		...
		keywords: ["programming", "developer", "script"],
	},
	{
		id: "folder",
		iconName: "Folder",
	...
	{ id: "cloud", iconName: "CloudUpload", name: "Cloud", category: "Files", keywords: ["upload", "storage", "sync"] },
	{
		...
		name: "Flash",
		category: "Interface",
		keywords: ["lightning", "fast", "speed", "rocket"],
	},
	{
		id: "security",
		...
		name: "Security",
		category: "Security",
		keywords: ["protection", "safe", "verified"],
	},
	{
		id: "shield",
		iconName: "Shield",
		name: "Shield",
		category: "Security",
		keywords: ["protection", "guard", "defense"],
	},
	{
		id: "bookmark",
		iconName: "Bookmark",
	...
	},
	{
		...
		name: "Menu",
		category: "Interface",
		keywords: ["navigation", "hamburger", "list"],
	},
	{
		id: "settings",
		iconName: "Settings",
	...
	},
	{
		...
		name: "Check",
		category: "Interface",
		keywords: ["tick", "done", "complete", "success"],
	},
	{
		id: "check-circle",
		...
		name: "Check Circle",
		category: "Interface",
		keywords: ["verified", "approved", "success"],
	},
	{
		id: "check-badge",
		iconName: "CheckBadge",
		name: "Check Badge",
		category: "Interface",
		keywords: ["verified", "certified", "approved"],
	},
	{
		id: "alert",
		iconName: "Alert",
	...
	},
	{
		...
		name: "Alert Circle",
		category: "Interface",
		keywords: ["info", "warning", "notification"],
	},
	{ id: "info", iconName: "Info", name: "Info", category: "Interface", keywords: ["information", "help", "details"] },
	{
		...
		name: "Cancel",
		category: "Interface",
		keywords: ["close", "remove", "delete", "x"],
	},
	...
	},
	{
		...
		name: "Dollar",
		category: "Finance",
		keywords: ["money", "payment", "price", "currency"],
	},
	{
		id: "credit-card",
		iconName: "CreditCard",
	...
	{ id: "ticket", iconName: "Ticket", name: "Ticket", category: "Commerce", keywords: ["coupon", "voucher", "pass"] },
	{
		...
		name: "License",
		category: "Security",
		keywords: ["certificate", "permit", "key"],
	},
	{ id: "key", iconName: "Key", name: "Key", category: "Security", keywords: ["password", "access", "unlock"] },
	{
		...
		name: "Shield Key",
		category: "Security",
		keywords: ["secure", "protected", "auth"],
	},
	{
		id: "arrow-right",
		iconName: "ArrowRight",
	...
	},
	{
		...
		name: "Arrow Down",
		category: "Arrows",
		keywords: ["decrease", "fall", "bottom"],
	},
	{
		id: "return",
		iconName: "ReturnRequest",
		name: "Return",
		category: "Interface",
		keywords: ["back", "undo", "revert"],
	},
	{
		id: "export",
		iconName: "FileExport",
	...
	},
	{
		...
		name: "Test Tube",
		category: "Science",
		keywords: ["experiment", "lab", "testing"],
	},
	{
		id: "book",
		iconName: "BookOpen",
		name: "Book",
		category: "Education",
		keywords: ["read", "documentation", "manual"],
	},
	{
		id: "chart",
