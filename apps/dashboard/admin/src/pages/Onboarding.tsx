			...
			<div>
				...
				<div className="integrations-grid">
					<div className="integration-card">
						<div className="integration-icon" style={{ background: "#000" }}>
					...
					<div className="integration-card">
						<div className="integration-icon" style={{ background: "#61DAFB" }}>
					...
					<div className="integration-card">
						<div className="integration-icon" style={{ background: "#F7DF1E" }}>
							<svg viewBox="0 0 24 24" fill="#000">
					...
					<div className="integration-card">
						<div className="integration-icon" style={{ background: "#02569B" }}>
							<svg viewBox="0 0 24 24" fill="white">
					...
					<div className="integration-card">
						<div className="integration-icon" style={{ background: "#47A248" }}>
							<svg viewBox="0 0 24 24" fill="white">
