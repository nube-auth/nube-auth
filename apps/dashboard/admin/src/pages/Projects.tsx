			...
			{!hasProjects && (
				<div style={{
					...
					<div style={{
						...
						<svg style={{ width: "56px", height: "56px", color: "var(--primary)" }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
					...
					<p style={{ fontSize: "15px", color: "var(--text-secondary)", maxWidth: "480px", marginBottom: "32px", lineHeight: "1.6" }}>
						Get started by creating your first project. Projects help you organize your applications and manage authentication across your services.
					</p>
					<button
						type="button"
						...
						>
							...
							<div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px" }}>
								<div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
									...
									<div>
										...
										{project.slug && (
											<p style={{ fontSize: "12px", color: "var(--text-tertiary)" }}>{project.slug}</p>
										)}
									</div>
								</div>
								<span style={{
							...
							<div style={{
								...
								<div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
									<svg style={{ width: "13px", height: "13px", color: "var(--success)" }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
							...
							{projects.map((project) => (
								...
								>
									<td style={{ padding: "16px" }}>
										<div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
											...
											<div>
												...
												{project.slug && (
													<div style={{ fontSize: "12px", color: "var(--text-tertiary)" }}>{project.slug}</div>
												)}
											</div>
										</div>
									</td>
									...
									<td style={{ padding: "16px", textAlign: "center" }}>
										<span style={{ fontSize: "15px", fontWeight: "600", color: "var(--text-primary)" }}>
											{project.activeLicenses || 0}
											<span style={{ fontSize: "13px", color: "var(--text-tertiary)", fontWeight: "400", marginLeft: "2px" }}>
