...
export function LoginPage() {
  ...
  useEffect(() => {
    ...
    const coreAuthUrl = `${import.meta.env.VITE_CORE_URL || 'http://localhost:3001'}/v1/auth/start?provider=google&redirect=${encodeURIComponent(window.location.origin + '/login')}`;
