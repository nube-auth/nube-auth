			...
			<div>
				<div className="mb-6">
					<Button
						...
						className="text-primary cursor-pointer bg-transparent border-none text-sm font-medium"
					>
						← Back to Refunds
					</Button>
				</div>
				...
				<Card>
					<CardBody className="max-w-[600px]">
						<div className="p-6">
							...
							<form onSubmit={handleCreateRefund}>
								...
								{refundForm.purchase_id && purchasesQuery.data?.data && (
									<div className="p-4 bg-surface-secondary rounded-lg mb-5">
										...
										{(() => {
											const purchase = purchasesQuery.data.data.find(
												(p) => p.id === refundForm.purchase_id,
											);
											...
											return (
												<div className="text-sm text-muted">
													...
													<div>
														...
														{handleProviderBadge(purchase.provider)}
													</div>
												</div>
											);
										})()}
								...
								<Alert variant="info" className="mb-6">
									<div className="text-info leading-relaxed">
										<strong>ℹ️ Note:</strong> Refund processing may take 24-48 hours depending on the
										payment provider.
									</div>
								</Alert>
