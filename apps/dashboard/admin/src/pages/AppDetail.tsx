				...
				<div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "16px" }}>
					...
					>
						...
						<div>
							...
							<div style={{ fontSize: "12px", color: "var(--text-tertiary)" }}>View & invite</div>
						</div>
					</button>
					...
					>
						...
						<div>
							...
							<div style={{ fontSize: "12px", color: "var(--text-tertiary)" }}>Plans & billing</div>
						</div>
					</button>
					...
					>
						...
						<div>
							...
							<div style={{ fontSize: "12px", color: "var(--text-tertiary)" }}>Auth & config</div>
						</div>
					</button>
					...
					>
						...
						>
							<svg
								style={{ width: "24px", height: "24px", color: "rgb(251, 146, 60)" }}
								fill="none"
								stroke="currentColor"
								viewBox="0 0 24 24"
							>
						...
						<div>
							...
							<div style={{ fontSize: "12px", color: "var(--text-tertiary)" }}>Integration</div>
						</div>
					</button>
				</div>
			</div>
