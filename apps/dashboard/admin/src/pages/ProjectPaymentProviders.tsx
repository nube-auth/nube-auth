...
import { useProject, useProjectPaymentProviders, useCreatePaymentProvider, useUpdatePaymentProvider, useDeletePaymentProvider } from "../hooks/api";
					...
					<>
						<div className="form-group">
							...
							<input
								...
								onChange={(e) => setFormData({ ...formData, config: { ...config, storeId: e.target.value } })}
								required
							/>
						</div>
						<div className="form-group">
							...
							<input
								...
								id="apiKey"
								value={config.apiKey || ""}
								onChange={(e) => setFormData({ ...formData, config: { ...config, apiKey: e.target.value } })}
								required
							/>
						</div>
					</>
					...
					<>
						...
						<div className="form-group">
							...
							<input
								...
								onChange={(e) => setFormData({ ...formData, config: { ...config, webhookSecret: e.target.value } })}
								required
							/>
						</div>
					</>
					...
					<>
						<div className="form-group">
							...
							<input
								...
								onChange={(e) => setFormData({ ...formData, config: { ...config, publishableKey: e.target.value } })}
								required
							/>
						</div>
						<div className="form-group">
							...
							<input
								...
								onChange={(e) => setFormData({ ...formData, config: { ...config, secretKey: e.target.value } })}
								required
							/>
						</div>
						<div className="form-group">
								...
								>
									...
									<td style={{ padding: "14px 16px" }}>
										<span style={{
											display: "inline-block",
											padding: "4px 10px",
											background: provider.environment === "production" ? "rgba(34, 197, 94, 0.1)" : "rgba(251, 191, 36, 0.1)",
											color: provider.environment === "production" ? "var(--success)" : "#f59e0b",
											borderRadius: "12px",
											fontSize: "12px",
											fontWeight: "500",
											textTransform: "capitalize",
									...
									<td style={{ padding: "14px 16px" }}>
										<span style={{
											...
											gap: "4px",
											padding: "4px 10px",
											background: provider.isActive ? "rgba(34, 197, 94, 0.1)" : "var(--surface-secondary)",
