...
export function AppSetupPage() {
	...
	return (
		<div className="page bg-content-bg min-h-screen">
			...
			{/* 2 Column Layout */}
			<div className="grid grid-cols-[1.4fr_1fr] gap-10 py-5 px-10 max-w-[1600px] mx-auto">
				{/* Left Column - Form */}
				<div>
					<div className="mb-8">
							...
							<form onSubmit={handleSubmit} className="flex flex-col gap-8">
								...
								{step === 1 && (
									<div className="space-y-6">
										...
										<Field>
											<FieldLabel htmlFor="slug">App Slug</FieldLabel>
											<Input
												type="text"
												id="slug"
												name="slug"
								...
								{step === 3 && (
									<div className="space-y-6">
										<Field>
											<FieldLabel htmlFor="sessionTtlDays">Session TTL (days)</FieldLabel>
											<Input
												type="number"
												id="sessionTtlDays"
												name="sessionTtlDays"
										...
										<div className="p-4 rounded-xl bg-surface-secondary border border-border-primary">
											<h3 className="text-14px font-semibold mb-3 text-text-primary">
								...
								{step === 4 && (
									<div className="space-y-6">
											...
											<FieldLabel className="flex items-center gap-3 cursor-pointer">
												<Checkbox
													...
													onCheckedChange={(checked) =>
														setFormData({
															...formData,
															requiresLicensing: checked === true,
														})
													}
												/>
										...
										{formData.requiresLicensing && (
											<div className="p-5 rounded-xl bg-surface-secondary border border-border-primary">
												...
												<div className="space-y-4">
													...
													<Field>
														<FieldLabel htmlFor="planDescription">Description</FieldLabel>
														<Textarea
															id="planDescription"
					...
					<div className="sticky top-5">
						<Card className="bg-surface-secondary">
							<CardBody>
								...
								{/* Mock Login Card */}
								<div className="bg-content-bg rounded-2xl py-10 px-8 border border-border-primary text-center">
									{/* App Icon */}
									<div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-5 bg-surface-secondary">
								...
								{/* Info Note */}
								<div className="mt-5 p-3 bg-primary-light border border-primary rounded-lg flex gap-2 items-start">
									<Icon
