				...
				<>
					...
					<div className="card" style={{ padding: "24px", marginBottom: "16px" }}>
						...
						<div style={{ display: "grid", gap: "24px" }}>
							<div>
								<p style={{ fontSize: "12px", color: "var(--text-tertiary)", marginBottom: "6px", textTransform: "uppercase", fontWeight: "600", letterSpacing: "0.5px" }}>
									Project Name
								</p>
							...
							<div>
								...
								<p style={{ fontSize: "15px", color: "var(--text-primary)", fontWeight: "600", fontFamily: "monospace", margin: 0 }}>
									{project.slug || "—"}
								</p>
							</div>
