				...
				<div className="mb-4 flex items-center justify-between gap-3">
					...
					<div className="flex items-center gap-2">
						{isRetryable && (
							...
							>
								{retryWebhook.isPending && retryingWebhookId === webhook.id
									? "Retrying..."
									: "Retry Webhook"}
							</Button>
						)}
				...
				<Card>
					<CardBody>
						...
						{webhook.error_message &&
							(webhook.status === "failed" || webhook.status === "signature_failed") && (
								<div className="mb-5 rounded-lg border border-danger/30 bg-danger/10 p-3">
									...
									<code className="text-12px text-danger font-mono wrap-break-word">
										{webhook.error_message}
									</code>
								</div>
							)}
							...
							<div className="xl:col-span-4 space-y-4">
								...
								{webhook.event_id && (
									<div className="rounded-lg bg-surface-secondary p-4">
										...
										<code className="text-12px text-text-primary font-mono wrap-break-word">
											{webhook.event_id}
										</code>
									</div>
								)}
								...
								<div className="grid grid-cols-1 gap-4 w-full">
									...
									{webhook.error_stack && (
										<div className="rounded-lg bg-danger/10 border border-danger/30 p-4">
											<Heading level={4} size="sm" className="mb-3 text-danger">
												Stack Trace
											</Heading>
