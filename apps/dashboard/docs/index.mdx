---
title: Nube Auth Documentation
description: Complete documentation for the Nube Auth authentication and licensing platform
template: splash
hero:
  ...
  actions:
    - text: Quick Start →
      ...
      variant: primary
    - text: View on GitHub
      link: https://github.com/yourorg/nube-auth
      icon: external
---
