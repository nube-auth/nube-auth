...
function getDeviceIcon(os: string) {
	if (os === "iOS" || os === "Android") {
		// Mobile icon - using custom since we need specific styling
		return (
			<svg className="w-4.5 h-4.5 text-text-tertiary" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
