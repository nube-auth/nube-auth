...
import type { DodoCredentials, LemonSqueezyCredentials, PaymentProviderAdapter, StripeCredentials } from "./types.js";
 ...
 */
export function createProviderAdapter(provider: string, credentials: unknown): PaymentProviderAdapter {
	switch (provider) {
		case "stripe":
