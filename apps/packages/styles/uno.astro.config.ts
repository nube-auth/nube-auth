...
// UnoCSS config for Astro sites (docs, home)
// Does NOT include daisyUI preset due to compatibility issues with Astro build
export default defineConfig({
	...
	shortcuts: {
		// Buttons - standalone implementation for Astro
		"btn-base":
