...
export function Kbd({ variant, className, ...props }: React.ComponentProps<"kbd"> & VariantProps<typeof kbdVariants>) {
...
export function KbdGroup({ className, ...props }: React.ComponentProps<"div">) {
	return <div data-slot="kbd-group" {...props} className={cn("flex items-center gap-1.5", className)} />;
}
