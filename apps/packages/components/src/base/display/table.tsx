...
export function Table({ ...props }: React.ComponentProps<"table">) {
	return (
		<table data-slot="table" {...props} className={cn("w-full text-table-foreground text-left", props.className)} />
	);
}

export function TableContainer({ ...props }: React.ComponentProps<"div">) {
	return <div data-slot="table-container" {...props} className={cn("overflow-x-auto", props.className)} />;
}
...
export function TableHead({ ...props }: React.ComponentProps<"th">) {
	return (
		<th
			...
			{...props}
			className={cn(
				"px-6 py-2 text-muted font-medium bg-table-head border-b border-table-separator",
				props.className,
			)}
		/>
	);
...
export function TableRow({ ...props }: React.ComponentProps<"tr">) {
	return (
		<tr
			data-slot="table-row"
			{...props}
			className={cn("border-b border-table-separator last:border-none hover:bg-table-accent", props.className)}
		/>
	);
}
...
export function TableFooter({ ...props }: React.ComponentProps<"tfoot">) {
	return (
		<tfoot data-slot="table-footer" {...props} className={cn("text-xs text-muted-foreground", props.className)} />
	);
}
