...
export function PreviewCard({ children, ...props }: React.ComponentProps<typeof BasePreviewCard.Root>) {
	return <BasePreviewCard.Root {...props}>{children}</BasePreviewCard.Root>;
}

export function PreviewCardTrigger({ children, ...props }: React.ComponentProps<typeof BasePreviewCard.Trigger>) {
