...
export function MenuItem({ ...props }: React.ComponentProps<typeof BaseMenu.Item>) {
	return <BaseMenu.Item data-slot="menu-item" {...props} className={cn(menuItemClassName, props.className)} />;
}
...
export function MenuSubmenuTrigger({ ...props }: React.ComponentProps<typeof BaseMenu.SubmenuTrigger>) {
	return (
...
export function MenuCheckboxItem({ children, ...props }: React.ComponentProps<typeof BaseMenu.CheckboxItem>) {
	return (
...
export function MenuRadioItem({
	...
	return (
		...
		>
			<div data-slot="menu-radio-item-indicator" className="flex items-center justify-center size-3 rounded-full">
