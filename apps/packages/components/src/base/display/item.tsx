...
export function ItemContent({ className, ...props }: React.ComponentProps<"div">) {
	return <div data-slot="item-content" className={cn("flex flex-col items-start gap-0.5", className)} {...props} />;
}

export function ItemTitle({ className, ...props }: React.ComponentProps<"div">) {
	return <div data-slot="item-title" className={cn("text-foreground font-medium", className)} {...props} />;
}

export function ItemDescription({ className, ...props }: React.ComponentProps<"p">) {
	return <p data-slot="item-description" className={cn("text-muted leading-relaxed", className)} {...props} />;
}

export function ItemMeta({ className, ...props }: React.ComponentProps<"div">) {
	return <div data-slot="item-meta" className={cn("text-dimmed text-sm leading-relaxed", className)} {...props} />;
}
...
export function ItemMedia({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn("shrink-0 *:[[data-slot=iconbox]]:size-9 [&_svg:not([class*=size-])]:size-4.5", className)}
			{...props}
		/>
	);
}
...
export function ItemAction({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn("ml-auto flex items-center gap-2.5 [&_svg:not([class*=size-])]:size-4", className)}
			{...props}
		/>
	);
}
