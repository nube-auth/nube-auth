...
export function Collapsible({ className, ...props }: React.ComponentProps<typeof BaseCollapsible.Root>) {
	return <BaseCollapsible.Root data-slot="collapsible" className={cn("flex flex-col", className)} {...props} />;
}
