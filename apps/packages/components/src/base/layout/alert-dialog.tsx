...
export function AlertDialogTrigger({ children, ...props }: React.ComponentProps<typeof BaseAlertDialog.Trigger>) {
	return (
...
export function AlertDialogHeader({ className, children, ...props }: React.ComponentProps<"header">) {
	return (
		<header
...
export function AlertDialogBody({ className, children, ...props }: React.ComponentProps<"div">) {
	return (
		<div data-slot="alert-dialog-body" {...props} className={cn("px-6 py-4.5", className)}>
			{children}
		</div>
	);
}
...
export function AlertDialogFooter({ className, children, ...props }: React.ComponentProps<"footer">) {
	return (
		<footer
