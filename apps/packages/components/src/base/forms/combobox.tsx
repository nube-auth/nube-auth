	...
	],
	{
		variants: {
			variant: {
				...
				subtle: "bg-input/60 ring ring-input-border hover:not-[[data-disabled]]:not-[:focus]:ring-input-accent-border shadow-input",
...
export function ComboboxTrigger({
	...
	variant,
	...props
}: React.ComponentProps<typeof BaseCombobox.Trigger> & VariantProps<typeof comboboxTriggerVariants>) {
	return (
...
export function ComboboxValue({
	...
	return (
		<BaseCombobox.Value data-slot="combobox-value" {...props}>
			{(value: string | ComboboxItem) => <ComboboxRenderValue value={value} placeholder={placeholder} />}
		</BaseCombobox.Value>
	);
}

function ComboboxRenderValue({ value, placeholder }: { value: string | ComboboxItem; placeholder: string }) {
	if (!value) {
...
export function ComboboxSearch({ className, ...props }: React.ComponentProps<typeof BaseCombobox.Input>) {
	return (
		<div className="p-1">
			<BaseCombobox.Input
...
export function ComboboxList({ className, ...props }: React.ComponentProps<typeof BaseCombobox.List>) {
	return (
		<BaseCombobox.List
...
export function ComboboxItem({ children, className, ...props }: React.ComponentProps<typeof BaseCombobox.Item>) {
	return (
		<BaseCombobox.Item
...
export function ComboboxGroup({ className, ...props }: React.ComponentProps<typeof BaseCombobox.Group>) {
	return <BaseCombobox.Group data-slot="combobox-group" {...props} className={cn("space-y-0.5", className)} />;
}

export function ComboboxGroupLabel({ className, ...props }: React.ComponentProps<typeof BaseCombobox.GroupLabel>) {
	return (
...
export function ComboboxSeparator({ className, ...props }: React.ComponentProps<typeof BaseCombobox.Separator>) {
	return (
