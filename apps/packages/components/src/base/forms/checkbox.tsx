...
export function CheckboxGroup({ className, ...props }: React.ComponentProps<typeof BaseCheckboxGroup>) {
	return (
		<BaseCheckboxGroup data-slot="checkbox-group" {...props} className={cn("flex flex-col gap-2.5", className)} />
	);
}
