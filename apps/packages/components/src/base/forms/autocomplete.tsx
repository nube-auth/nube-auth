...
export function AutocompleteInput({
	...
	variant,
	...props
}: React.ComponentProps<typeof BaseAutocomplete.Input> & VariantProps<typeof autocompleteInputVariants>) {
	return (
...
export function AutocompleteClear({ ...props }: React.ComponentProps<typeof BaseAutocomplete.Clear>) {
	return <BaseAutocomplete.Clear data-slot="autocomplete-clear" {...props} />;
}

export function AutocompleteValue({ ...props }: React.ComponentProps<typeof BaseAutocomplete.Value>) {
	return <BaseAutocomplete.Value data-slot="autocomplete-value" {...props} />;
}

export function AutocompleteTrigger({ ...props }: React.ComponentProps<typeof BaseAutocomplete.Trigger>) {
	return <BaseAutocomplete.Trigger data-slot="autocomplete-trigger" {...props} />;
}

export function AutocompleteEmpty({ className, ...props }: React.ComponentProps<typeof BaseAutocomplete.Empty>) {
	return (
...
export function AutocompleteList({ className, ...props }: React.ComponentProps<typeof BaseAutocomplete.List>) {
	return (
...
export function AutocompleteGroup({ className, ...props }: React.ComponentProps<typeof BaseAutocomplete.Group>) {
	return (
		<BaseAutocomplete.Group data-slot="autocomplete-group" {...props} className={cn("pb-2 last:pb-0", className)} />
	);
}
...
export function AutocompleteCollection({ ...props }: React.ComponentProps<typeof BaseAutocomplete.Collection>) {
	return <BaseAutocomplete.Collection data-slot="autocomplete-collection" {...props} />;
}

export function AutocompleteRow({ className, ...props }: React.ComponentProps<typeof BaseAutocomplete.Row>) {
	return <div data-slot="autocomplete-row" {...props} className={cn(className)} />;
}

export function AutocompleteItem({ className, ...props }: React.ComponentProps<typeof BaseAutocomplete.Item>) {
	return (
