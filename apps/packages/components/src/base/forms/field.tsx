...
export function Field({ className, ...props }: React.ComponentProps<typeof BaseField.Root>) {
	return <BaseField.Root data-slot="field" className={cn("flex gap-2 flex-col", className)} {...props} />;
}
...
export function FieldError({ className, ...props }: React.ComponentProps<typeof BaseField.Error>) {
	return <BaseField.Error data-slot="field-error" className={cn("text-danger", className)} {...props} />;
}
