...
export function Slider({ className, children, ...props }: React.ComponentProps<typeof BaseSlider.Root>) {
	return (
...
export function SliderThumb({ className, ...props }: React.ComponentProps<typeof BaseSlider.Thumb>) {
	return (
		<BaseSlider.Thumb
