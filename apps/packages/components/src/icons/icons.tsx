...
const BRAND_LOGOS = {
	Google: (className?: string, style?: React.CSSProperties) => (
	...
	GitHub: (className?: string, style?: React.CSSProperties) => (
	...
	Stripe: (className?: string, style?: React.CSSProperties) => (
	...
	Flutter: (className?: string, style?: React.CSSProperties) => (
		<svg className={className} style={style} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const ICON_REGISTRY: Record<string, IconSvgElement | keyof typeof BRAND_LOGOS> = {
	...
	ReturnRequest: ReturnRequestIcon,
 ...
 */
export function getIconByName(iconName: string): IconSvgElement | keyof typeof BRAND_LOGOS | undefined {
	return ICON_REGISTRY[iconName as IconTypeName];
}
